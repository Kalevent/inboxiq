...
@app.cli.command("seed-cost-of-slow-support-REMOVE_THIS_DEAD_CODE")
def cli_seed_cost_of_slow_support_dead():
    """placeholder — delete this"""
    _CONTENT_HTML = (
        '<section class="prose prose-invert prose-headings:font-semibold prose-headings:text-white'
        ' prose-a:text-indigo-200 prose-li:marker:text-indigo-300 max-w-none">\n'
        "  <p>A customer emails your support team. They wait four hours. Then eight. By the time"
        " someone replies, they\u2019ve already posted in a public forum, filed a chargeback, or"
        " quietly cancelled their subscription. Slow support isn\u2019t just an inconvenience\u2014it"
        " has a measurable cost that compounds with every missed SLA.</p>\n\n"
        '  <h2 class="text-xl">What \u201cslow\u201d actually means</h2>\n'
        "  <p>Customers don\u2019t grade on a curve. Research consistently shows:</p>\n"
        "  <ul>\n"
        "    <li>60% of customers expect a first response within one hour for email support.</li>\n"
        "    <li>After four hours with no reply, intent to churn roughly doubles.</li>\n"
        "    <li>A single public complaint amplified by social media can reach thousands before"
        " your team has even opened the ticket.</li>\n"
        "  </ul>\n"
        "  <p>For B2B SaaS, the stakes are higher. Enterprise and mid-market customers have SLA"
        " clauses\u2014breach them and you trigger credits, escalations, or contract reviews.</p>\n\n"
        '  <h2 class="text-xl">The four ways slow support costs you money</h2>\n\n'
        '  <h3 class="text-lg">1. Direct churn</h3>\n'
        "  <p>Poor support experience is the second most common reason B2B customers switch vendors"
        " (after price). If your median first-response time is above two hours, you are actively"
        " contributing to churn that your sales team is working hard to prevent. Even a one-hour"
        " improvement in FRT can lift retention by several percentage points\u2014worth tens of"
        " thousands of pounds annually for a company with \u00a3500k ARR.</p>\n\n"
        '  <h3 class="text-lg">2. Expansion revenue at risk</h3>\n'
        "  <p>Customers who feel neglected do not expand. Upsells and seat increases happen when"
        " the customer feels cared for. A customer who has waited 12 hours for a response on a"
        " billing question is not going to say yes to a higher plan. Slow support suppresses NPS,"
        " and low NPS suppresses net revenue retention.</p>\n\n"
        '  <h3 class="text-lg">3. Agent burnout and error rates</h3>\n'
        "  <p>When inboxes overflow, agents rush. Rushed agents make mistakes: wrong answers,"
        " missed context, duplicate replies, or no reply at all. Fixing those errors takes more"
        " time than handling the original message correctly would have. Worse, burned-out agents"
        " leave\u2014and replacement cost for a support agent (recruitment, onboarding, ramp-up)"
        " is typically 1.5\u20132x annual salary.</p>\n\n"
        '  <h3 class="text-lg">4. Reputational damage</h3>\n'
        "  <p>Review sites and community forums are permanent. A single thread titled \u201cSupport"
        " took three days to reply\u201d can suppress inbound conversions for months. For SaaS"
        " products evaluated on trust, reputation is a sales asset\u2014or liability.</p>\n\n"
        '  <h2 class="text-xl">Why response times slip</h2>\n'
        "  <p>Teams rarely set out to be slow. Response times slip because of structural problems"
        " that get worse as volume grows:</p>\n"
        "  <ul>\n"
        "    <li><strong>No triage:</strong> every message hits a shared inbox with no routing,"
        " so urgent and trivial sit side by side.</li>\n"
        "    <li><strong>Manual categorisation:</strong> agents spend the first minutes of every"
        " shift sorting rather than responding.</li>\n"
        "    <li><strong>No ownership:</strong> when everyone is responsible, no one is\u2014"
        "messages age unnoticed.</li>\n"
        "    <li><strong>No visibility:</strong> team leads can\u2019t see the backlog clearly"
        " enough to reallocate before SLAs breach.</li>\n"
        "    <li><strong>Context switching:</strong> agents toggle between inboxes, tickets, and"
        " CRM, losing minutes on every message.</li>\n"
        "  </ul>\n\n"
        '  <h2 class="text-xl">Calculating your true cost</h2>\n'
        "  <p>A rough model for a 10-person SaaS team with \u00a31m ARR:</p>\n"
        "  <ul>\n"
        "    <li>Average contract value: \u00a35,000/year.</li>\n"
        "    <li>Churn attributable to poor support (conservative): 5% of churned accounts.</li>\n"
        "    <li>10 accounts \xd7 \u00a35,000 = <strong>\u00a350,000/year in preventable churn.</strong></li>\n"
        "    <li>Expansion suppression (rough estimate): a further \u00a315,000\u201330,000 in"
        " upsells that never close because satisfaction is low.</li>\n"
        "  </ul>\n"
        "  <p>For most teams, fixing response time is worth more than any single marketing"
        " campaign.</p>\n\n"
        '  <h2 class="text-xl">What high-performing teams do differently</h2>\n'
        "  <ol>\n"
        "    <li><strong>Triage at the point of arrival.</strong> Messages are categorised and"
        " prioritised the moment they land\u2014not when an agent gets to them.</li>\n"
        "    <li><strong>Hard ownership.</strong> Every message is assigned within minutes. No"
        " \u201cshared inbox drift\u201d where everyone assumes someone else will reply.</li>\n"
        "    <li><strong>SLA alerts before the breach.</strong> Alerts fire at 50% and 80% of"
        " the SLA window\u2014not after the clock runs out.</li>\n"
        "    <li><strong>Draft replies at speed.</strong> AI-assisted drafts mean agents review"
        " and send rather than compose from scratch\u2014cutting handle time by 40\u201360%.</li>\n"
        "    <li><strong>Feedback loops.</strong> Team leads review SLA attainment weekly and"
        " adjust routing rules before problems compound.</li>\n"
        "  </ol>\n\n"
        '  <h2 class="text-xl">The role of AI triage</h2>\n'
        "  <p>The single highest-leverage change most teams can make is automating the triage step."
        " When AI reads each incoming message, assigns a category (billing, technical, refund,"
        " general), scores urgency, and routes it to the right agent\u2014all before a human has"
        " opened the inbox\u2014first-response times drop sharply. Teams that have done this"
        " typically see:</p>\n"
        "  <ul>\n"
        "    <li>Median FRT cut by 60\u201375% within the first two weeks.</li>\n"
        "    <li>SLA attainment rising from 70\u201375% to 90%+ within a month.</li>\n"
        "    <li>Agent capacity increasing without adding headcount.</li>\n"
        "  </ul>\n"
        '  <p>See how AI triage works in practice: <a href="/blog/ai-email-triage"'
        ' class="font-semibold">AI Email Triage \u2014 How It Works</a>.</p>\n\n'
        '  <h2 class="text-xl">A practical starting point</h2>\n'
        "  <ol>\n"
        "    <li>Measure your current median FRT and SLA attainment over the last 30 days.</li>\n"
        "    <li>Identify your top three inbox bottlenecks (no owner, wrong category, late"
        " escalation).</li>\n"
        "    <li>Define four to six message categories with clear routing rules.</li>\n"
        "    <li>Set SLA targets by priority (P1: 1 hour, P2: 4 hours, P3: 1 business day).</li>\n"
        "    <li>Turn on AI triage in observe mode for one week, then activate routing.</li>\n"
        "  </ol>\n\n"
        '  <div class="mt-6 p-4 rounded-xl border border-indigo-500/30 bg-indigo-500/10">\n'
        '    <div class="text-sm text-indigo-100 font-semibold mb-1">Ready to cut response'
        " times?</div>\n"
        '    <p class="text-sm text-slate-200">InboxIQ triages, prioritises, and routes every'
        " incoming message automatically. Most teams are live in under an hour.</p>\n"
        '    <div class="mt-3 flex flex-wrap gap-3">\n'
        '      <a href="/upgrade" class="inline-flex items-center gap-2 px-4 py-2 rounded-full'
        ' bg-indigo-500 hover:bg-indigo-400 text-sm font-semibold text-white">Start free'
        " trial</a>\n"
        '      <a href="/contact" class="inline-flex items-center gap-2 px-4 py-2 rounded-full'
        ' border border-indigo-300/50 text-sm font-semibold text-indigo-100'
        ' hover:bg-indigo-500/10">Talk to us</a>\n'
        "    </div>\n"
        "  </div>\n"
        "</section>"
    )
    ...
    post = BlogPost(
        ...
        content_html=_CONTENT_HTML,
        meta_description=(
            "Slow support response times cost B2B SaaS companies through churn, suppressed"
            " expansion, and reputational damage. Here\u2019s how to measure and fix it."
        ),
        primary_keyword="cost of slow support",
        secondary_keywords=["slow customer support", "support response time", "SLA breach", "customer churn"],
        funnel_stage="tofu",
        canonical_url="/blog/cost-of-slow-support",
        internal_links=[{"href": "/blog/ai-email-triage", "label": "AI Email Triage", "rel": "next"}],
        word_count=820,
