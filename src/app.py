...
def create_app() -> Flask:
  ...
  def set_security_headers(response):
    csp = "; ".join(
      [
        "default-src 'self'",
        "script-src 'self' 'unsafe-inline' https://js.stripe.com https://www.googletagmanager.com https://ssl.google-analytics.com https://www.google-analytics.com",
        "style-src 'self' 'unsafe-inline'",
        "img-src 'self' data: https://www.gravatar.com https://files.kalevent.com https://www.googletagmanager.com https://www.google-analytics.com https://ssl.google-analytics.com https://stats.g.doubleclick.net",
        "font-src 'self' data:",
        "connect-src 'self' https://127.0.0.1:8000 https://api.kalevent.com https://files.kalevent.com https://www.google-analytics.com https://ssl.google-analytics.com https://analytics.google.com https://stats.g.doubleclick.net https://region1.analytics.google.com https://region1.google-analytics.com",
  ...
  def sitemap():
    ...
    blog_posts = BlogPost.query.filter_by(status='published').order_by(BlogPost.published_at.desc().nullslast()).all()
    ...
    for post in blog_posts:
      lastmod = (post.published_at or post.updated_at or post.created_at).strftime("%Y-%m-%d")
      xml += '  <url>\n'
